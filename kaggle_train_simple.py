#!/usr/bin/env python3
"""
Simple Kaggle Training Script for Emotion Recognition
This script adds basic regularization to reduce overfitting.
"""
...
def train_model(config, args):
    """Train emotion recognition model with basic regularization."""
    # Setup logger
    logger = setup_logger(config['log_dir'], 'training')
    logger.info("=" * 60)
    logger.info("Starting Training with Basic Regularization")
    logger.info("=" * 60)
    ...
    if args.dropout_rate > 0:
        # Find the last linear layer before classifier
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train emotion recognition model on Kaggle - Simple Regularized Approach')
    ...
    parser.add_argument('--lr', type=float, default=0.001, 
                       help='Learning rate (default: 0.001, same as original)')
    ...
    parser.add_argument('--weight_decay', type=float, default=1e-4,
                       help='Weight decay (default: 1e-4, increased from 1e-4)')
    ...
    # Print configuration
    print("=" * 60)
    print("Kaggle Training Configuration (Simple Regularized)")
    print("=" * 60)
